...
if (function_exists('ini_set')) {
	$root = dirname(dirname(__FILE__)) . $ds . 'vendor' . $ds . 'kba-team';
...
define('TMP', dirname(dirname(__FILE__)) . $ds . 'tmp' . $ds);
define('WWW_ROOT', dirname(dirname(__FILE__)) . $ds . 'webroot' . $ds);
